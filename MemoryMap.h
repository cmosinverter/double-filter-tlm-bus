...
// DOUBLE filter Memory Map
// Used between SimpleBus & DoubleFilter
const int DOUBLE_MM_BASE = 0x90000000;
const int DOUBLE_MM_SIZE = 0x0000000C;
const int DOUBLE_MM_MASK = 0x0000000F;
